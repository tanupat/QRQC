...
class FormFactorTreeAnalysisforNonDetection extends Component {
  constructor(props) {
    super(props);
  }
  render() {
    ...
    return (
      <div>
        <Form>
          ...
          <Row>
            <Col {...set_col}>
              <FormItem {...formItemLayout} label="Complete date">
...
const _FormFactorTreeAnalysisforNonDetection = Form.create({
  name: "FormFactorTreeAnalysisforNonDetection"
})(FormFactorTreeAnalysisforNonDetection);

class FactorTreeAnalysisforNonDetection extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false
  ...
  render() {
    ...
    return (
      <div>
        <Card
          className="gx-card"
          title="Factor Tree Analysis for Non-Detection"
        >
          <Button type="primary" size="small" onClick={this.showModal}>
          ...
          <Modal
            ...
            width={1200}
          >
            <_FormFactorTreeAnalysisforNonDetection />
          </Modal>
        </Card>
      </div>
    );
...
export default FactorTreeAnalysisforNonDetection;
