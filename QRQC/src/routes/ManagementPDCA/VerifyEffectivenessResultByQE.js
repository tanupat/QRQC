...
class VerifyEffectivenessResultByQE extends Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return (
      <div>
        <Card className="gx-card" title="Verify Effectiveness Result by QE">
          <Form>
            <Row>
              <Col {...set_col}>
...
const FormVerifyEffectivenessResultByQE = Form.create({
  name: "VerifyEffectivenessResultByQE"
})(VerifyEffectivenessResultByQE);

export default FormVerifyEffectivenessResultByQE;
